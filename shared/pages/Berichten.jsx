...
function Berichten({ initialSubPage = null, onNavigate, onSubPageChange, notificationCount }) {
  ...
  const openChat = (chat, fromSubPage = null) => {
    setActiveChat({ ...chat, _fromSubPage: fromSubPage })
    setSubPage('chat')
  }

  /* ---- Sub-pages ---- */
  if (subPage === 'chat' && activeChat) {
    return <ChatGesprek chat={activeChat} onBack={() => { setSubPage(activeChat._fromSubPage || null); setActiveChat(null) }} />
  }
    ...
    return (
      <div className="berichten">
        <header className="berichten__sub-header">
          <button className="berichten__back" onClick={() => deepLinked ? onNavigate(PAGES.CAREPOOL) : setSubPage(null)} aria-label="Terug">
  ...
  return (
    <div className="berichten">
        ...
        <button className="berichten__verzoeken-card" onClick={() => setSubPage('verzoeken')}>
          <div className="berichten__verzoeken-left">
            <div className="berichten__verzoeken-top">
              <span className="berichten__verzoeken-title">Verkennende gesprekken</span>
              {badgeCount > 0 && (
      ...
      <div className="berichten__section-row">
        <div className="berichten__section-title-group">
          <h2 className="berichten__section-header">Chats</h2>
          <span className="berichten__section-subtitle">Mijn connecties</span>
        </div>
